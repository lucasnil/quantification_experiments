...
def main(difficulty_metric=None, difficulty_top_k=None, difficulty_mode=None, result_path=".", run=1):
    ...
    train_bag_generator = LeQuaBagGenerator(device='cpu', seed=SEED, prevalences=train_prevalences, sample_size=BAG_SIZE, app_bags_proportion=0.5, mixed_bags_proportion=0.5, labeled_unlabeled_split=(range(0, n_labeled), range(n_labeled, 2 * n_labeled)), difficulty_metric=difficulty_metric, difficulty_top_k=difficulty_top_k, difficulty_mode=difficulty_mode)
    val_bag_generator = UnlabeledBagGenerator(device='cpu', pick_all=False, seed=SEED, prevalences=val_prevalences, sample_size=BAG_SIZE)
    test_bag_generator = UnlabeledMixerBagGenerator(device='cpu', prevalences=test_prevalences, sample_size=BAG_SIZE, real_bags_proportion=3 / 100, seed=SEED)
