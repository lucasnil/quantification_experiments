...
def main(dataset_path):
    ...
    # ... código antes continua igual ...

    embeddings = torch.from_numpy(x)  # mantem em CPU
    labels = torch.from_numpy(y)      # mantem em CPU

    # --- Divisão em treino, validação e teste (tudo em numpy CPU mesmo) ---
    ...
    # Construir datasets (tudo em CPU)
    ...
    # Modelo pode usar device CUDA se disponível
...
if __name__ == "__main__":
    ...
    parser.add_argument("--data", required=True, help="Caminho para a pasta com o arquivo .csv do GASP")
