...
from dlquantification.quantmodule.other.BasicCount import BasicCount
...
class HistNetHistograms(torch.nn.Module):
    ...
    def __init__(self, histogram, input_size, n_bins=8, quantiles=False, n_classes=None):
        ...
        elif histogram == "basiccount":
            if n_bins != 1 or None:
                raise ValueError("For basic count the number of bins should be 1 or None")
            self.histogram = BasicCount(n_classes=n_classes)
